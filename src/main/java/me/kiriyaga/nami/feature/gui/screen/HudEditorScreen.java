...
public class HudEditorScreen extends BasePanelScreen {
    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        if (hudEditorModule != null && hudEditorModule.descriptions.get()) {
    ...
    public boolean keyPressed(int keyCode, int scanCode, int modifiers) {
        if (keyCode == getClickGuiModule().getKeyBind().get() && MC.world != null) {
            MC.setScreen(null);
            return true;
        }
